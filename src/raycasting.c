...
void cast_rays(SDL_Renderer *renderer) {
    for (int x = 0; x < SCREEN_WIDTH; x++) {
        ...
        switch (map[mapX][mapY]) {
            ...
            case 4: color = (side == 1) ? (SDL_Color){255, 255, 0, 255} : (SDL_Color){200, 200, 0, 255}; break;
            default: color = (side == 1) ? (SDL_Color){255, 255, 255, 255} : (SDL_Color){200, 200, 200, 255}; break;
        }
